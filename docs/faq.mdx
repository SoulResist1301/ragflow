...
RAGFlow supports indexing documents from local folders that are already mounted in the Docker container. This avoids duplicating files by directly indexing existing files without uploading them.
